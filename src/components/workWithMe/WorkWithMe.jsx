...
const WorkWithMe = () => {
    ...
    return (
        <div className={`transition-all font-GIT cursor-pointer border-opacity-50 duration-200 fixed bottom-[5%] w-[200px] h-[40px] flex justify-between items-center mr-4 p-4 rounded-md border-[1px] ${dark ? 'border-white text-white' : 'border-black text-black'}`}
            ...
            <div className='w-[80%] opacity-50 text-end '>Work With Me!</div>
        </div>
    )
}
